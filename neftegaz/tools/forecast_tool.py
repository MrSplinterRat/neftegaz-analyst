...
def apply_supply_scenario(
    ...
    return ForecastResult(
        ...
        # ★Оговорка об откате переживает сценарий. Сценарий двигает числа, но не
        # отменяет того факта, что отработал запасной метод: потеряв её здесь, мы
        # получили бы сценарный ответ, у которого причина подмены метода
        # известна коду и неизвестна читателю.
